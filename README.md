...
`pip install git+https://github.com/biomodels/MODEL0911202318.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL0911202318.git@20140916`

## Usage

Importing the model package.

`import MODEL0911202318 as model`
...
version02** ](http://www.cellml.org/models/guyton_muscle_blood_flow_control_20
08_version02)  
